...
function Modal({ car, chdate, redate }) {
  ...
  <div className="modal fade" id="carModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div className="modal-content">
      ...
      <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={handleSubmit}>Rent It Now</button>
      </div>
    </div>
    </div>
  </div>
