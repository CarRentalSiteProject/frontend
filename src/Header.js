            ...
            <header className="bg-dark">
                <nav className="navbar navbar-dark navbar-expand-lg shadow-none"> 
                    <div className="container"> 
                        <a className="align-items-center d-inline-flex fw-bold h4 mb-0 navbar-brand text-primary text-uppercase" href="#"> <svg version="1.0" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 100 100" width="2.5em" height="2.5em" className="me-1" fill="currentColor">
